...
public class SimpleFESTTest {
  ...
  public void setUp() {
    GuiActionRunner.execute(new GuiTask(){
      ...
      protected void executeInEDT() throws Throwable {
        ...
        text.setName("text");
        text
          .setText("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!#$%^&*()`~-_=+[{]}\\|;:'\",<.>/?^°´öäüÖÄÜß");
  ...
  public void testEnterText() {
    ...
    t.deleteText();
    t.enterText("äöüÖÄÜ");
    // t.enterText("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!#$%^&*()`~-_=+[{]}\\|;:'\",<.>/?^°´öäüÖÄÜß");
    t.requireText("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!#$%^&*()`~-_=+[{]}\\|;:'\",<.>/?^°´öäüÖÄÜß");
  }
}
