...
class KeyStrokeMappingDE extends AbstractKeyStrokeMapping implements KeyStrokeMapping {
    ...
    KeyStrokeMappingDE() {
        ...
        map.put(keyStroke(VK_SLASH, NO_MASK), '\u00DF');
        ...
        map.put(keyStroke(VK_A_UML, NO_MASK), '\u00E4');
        map.put(keyStroke(VK_A_UML, SHIFT_MASK), '\u00C4');
        map.put(keyStroke(VK_O_UML, NO_MASK), '\u00F6');
        map.put(keyStroke(VK_O_UML, SHIFT_MASK), '\u00D6');
        map.put(keyStroke(VK_U_UML, NO_MASK), '\u00FC');
        map.put(keyStroke(VK_U_UML, SHIFT_MASK), '\u00DC');
