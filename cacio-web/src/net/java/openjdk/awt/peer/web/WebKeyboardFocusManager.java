...
public class WebKeyboardFocusManager extends DefaultKeyboardFocusManager {
  ...
  private static final PlatformLogger focusLog = PlatformLogger
    .getLogger("net.java.openjdk.awt.peer.web.WebKeyboardFocusManager");
   ...
   * <p>
   * This method will throw a SecurityException if this KeyboardFocusManager is not the current KeyboardFocusManager for
   ...
   * <p>
   * This method does not actually change the active Window as far as the native windowing system is concerned. It
   * merely stores the value to be subsequently returned by <code>getActiveWindow()</code>. Use
   * <code>Component.requestFocus()</code> or <code>Component.requestFocusInWindow()</code>to change the active Window,
