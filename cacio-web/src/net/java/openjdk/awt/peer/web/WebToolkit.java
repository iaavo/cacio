...
public class WebToolkit extends CacioToolkit {
  ...
  private static Logger logger = Logger.getLogger("net.java.openjdk.awt.peer.web.CacioToolkit");
  ...
  @Override
  public TrayIconPeer createTrayIcon(final TrayIcon target) throws HeadlessException, AWTException {
    System.out.println("Tray Icons are not supported yet.");
    return new TrayIconPeer(){
      @Override
      ...
      @Override
      public void displayMessage(String arg0, String arg1, String arg2) {}
    };
  }
  ...
  protected int getScreenWidth() {
    ...
    GraphicsConfiguration config = WebGraphicsConfiguration.getDefaultConfiguration();
