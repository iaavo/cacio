...
class KeyStrokeMappingDE extends AbstractKeyStrokeMapping implements KeyStrokeMapping {
  ...
  public final static int VK_A_UML = KeyEvent.getExtendedKeyCodeForChar('Ä');

  public final static int VK_O_UML = KeyEvent.getExtendedKeyCodeForChar('Ö');

  public final static int VK_U_UML = KeyEvent.getExtendedKeyCodeForChar('Ü');
