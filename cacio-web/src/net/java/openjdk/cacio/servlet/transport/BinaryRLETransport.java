...
import net.java.openjdk.cacio.servlet.imgformat.RLEImageEncoder;
...
public class BinaryRLETransport extends BinaryTransport {
  ...
  public void prepareUpdate(List<ScreenUpdate> pendingUpdateList, TreeImagePacker packer, List<Integer> cmdList) {
    ...
    if (singleUpdate != null) {
      ...
      rleEncoder.encodeImageToStream(singleUpdate.getImage(),
                                     singleUpdate.getSrcX(),
                                     singleUpdate.getSrcY(),
                                     singleUpdate.getSrcX() + updateArea.getWidth(),
                                     singleUpdate.getSrcY() + updateArea.getHeight());
    } else {
      BufferedImage packedImage = new BufferedImage(packedRegionBox.getWidth(),
                                                    packedRegionBox.getHeight(),
