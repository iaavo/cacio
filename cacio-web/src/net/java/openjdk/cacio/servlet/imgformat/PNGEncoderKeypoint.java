...
public class PNGEncoderKeypoint extends PNGEncoder {
  ...
  private void loadKeypointEncoder() {
    try {
      ...
      keypointEncoderConstructor = keypointEncoderCls.getConstructor(new Class[] {BufferedImage.class,
                                                                                  boolean.class,
                                                                                  int.class,
                                                                                  int.class});
  ...
  public byte[] encode(BufferedImage img, int compression) {
    try {
      Object encoderInstance = keypointEncoderConstructor.newInstance(new Object[] {img,
                                                                                    Boolean.FALSE,
                                                                                    Integer.valueOf(0),
                                                                                    compression});
